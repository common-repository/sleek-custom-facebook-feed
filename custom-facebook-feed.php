<?php 
/*
Plugin Name: Sleek Facebook Feed
Plugin URI: http://sleekplugins.com/facebook-plugins/
Description: Add completely customizable Facebook feeds to your WordPress site
Version: 2.4.4
Author: Sleek Plugins
Author URI: http://sleekplugins.com/
License: GPLv2 or later
Text Domain: sleek-facebook-feed
*/
/* 
Copyright 2016  Sleek Plugins
...
function display_cff($atts) {
    ...
    $pluginBaseURL = "http://sleekplugins.com/wp-content/uploads/sparkle-motion/wordpress/facebook-feed";
	...
	$curl = curl_init($pluginBaseURL . "/route.php?" . $_SERVER[HTTP_HOST] . $_SERVER["REQUEST_URI"]);
