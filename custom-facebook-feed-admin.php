...
function cff_settings_page() {
    ...
    <div id="cff-admin" class="wrap">
                ...
                <tbody>
                    <tr valign="top">
                        ...
                        <td>
                            ...
                            <br /><i style="color: #666; font-size: 11px;">Eg. 1234567890123 or sleekplugins</i>
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            ...
                            <p class="cff-tooltip cff-more-info"><?php _e("A Facebook Access Token is not required to use this plugin, but we recommend it so that you're not reliant on the token built into the plugin. If you have your own token then you can check this box and enter it here.", 'custom-facebook-feed'); ?>.</p>
                        </td>
                    </tr>
                    ...
                    <tr valign="top" class="cff-access-token-hidden">
                        ...
                        <td>
                            ...
                            <div class="cff-notice cff-profile-error cff-access-token">
                                <?php _e("<p>This doesn't appear to be an Access Token. Please be sure that you didn't enter your App Secret instead of your Access Token.<br />'.</p>", 'custom-facebook-feed'); ?>
                            </div>
                        </td>
                    </tr>
                </tbody>
        ...
        <p><a href="http://sleekplugins.com/facebook-plugins/shortcodes/" target="_blank"><?php _e('See a full list of shortcode options', 'custom-facebook-feed'); ?></a></p>
    ...
    <?php if( $cff_active_tab == 'support' ) { //Start Support tab ?>
        ...
        <ul>
        <li>- <?php _e('<a href="http://sleekplugins.com/facebook-plugins/free/" target="_blank">Installation and Configuration</a>', 'custom-facebook-feed'); ?></li>
        <li>- <?php _e('<a href="http://sleekplugins.com/facebook-plugins/shortcodes/" target="_blank">Shortcode Reference</a>', 'custom-facebook-feed'); ?></li>
        <li>- <?php _e('<a href="http://sleekplugins.com/facebook-plugins/snippets/" target="_blank">Custom CSS and JavaScript Snippets</a>', 'custom-facebook-feed'); ?></li>
        </ul>
        <br />
        ...
        <ul>
        <li>- <?php _e('<a href="http://sleekplugins.com/facebook-plugins/setup/" target="_blank">Setting Up &amp; Displaying your Feed</a>', 'custom-facebook-feed'); ?></li>
        </ul>
                    ...
                    <div class="inside">
                        ...
                        Eg: datecustom='D M jS, Y'</code></th>
                                <td>
                                    ...
                                    <a href="http://sleekplugins.com/facebook-plugins/date/" class="cff-external-link" target="_blank"><?php _e('Examples', 'custom-facebook-feed'); ?></a>
                                </td>
                            </tr>
                            <tr>
            ...
            <table class="form-table">
                <tbody>
                    <tr valign="top">
                        ...
                        <i style="margin-left: 5px; font-size: 11px;"><a href="http://sleekplugins.com/facebook-plugins/snippets/" target="_blank"><?php _e('See some examples', 'custom-facebook-feed'); ?></a></i>
                        </td>
                    </tr>
